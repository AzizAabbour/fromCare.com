...
import { Suspense, useRef, useLayoutEffect, useEffect, useMemo, useState, Component } from 'react';
    ...
    if (this.state.hasError) {
      return (
        <div style={{ width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#888' }}>
          {this.props.placeholderSrc ? <img src={this.props.placeholderSrc} style={{ width: '100%', height: '100%', objectFit: 'contain' }} /> : 'Impossible de charger l\'aperçu 3D.'}
        </div>
      );
    }
  ...
  return (
    <Html center>
      {placeholderSrc ? (
        ...
        <div style={{ color: '#005ce6', fontWeight: 'bold' }}>{Math.round(progress)} %</div>
      )}
    </Html>
  );
};
...
const ModelInner = ({
  ...
  // Custom loader logic to handle different formats
...
const ModelViewer = ({
  ...
  return (
    ...
    >
      ...
      <ErrorBoundary placeholderSrc={placeholderSrc}>
        <Canvas
          shadows
          frameloop="demand"
